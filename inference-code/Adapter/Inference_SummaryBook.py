...
# 저장되어있는 Gemma 불러오거나, 아니면 Gemma도 추론하거나
is_gemma_train = sys.argv[4] 

BASE_MODEL = "google/gemma-2b-it"
FINETUNE_MODEL = "./exper/MergeModel/summaryBook-gemma-2b-it-sum-ko.Rank" + str(rank) + "." + dataset_size
...
test_dataset = "dataset-SummaryBook-400"
...
for i in range(test_num):
    ...
    if int(is_gemma_train) == 1:
        ...
        Gemma_file_name = "./exper/gemma_out/Gemma_SummaryBook_output_" + str(i) + ".txt"
        Gemma_file = open(Gemma_file_name, "w")
        Gemma_file.write(Gemma_out)
        Gemma_file.close()
        Gemma_time_name = "./exper/gemma_out/Gemma_SummaryBook_time_" + str(i) + ".txt"
    ...
    output_file = "./exper/InferenceResult/SummaryBook.Rank" + str(rank) + "." + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReport/SummaryBook_Inference.Rank" + str(rank) + "." + dataset_size + ".out"

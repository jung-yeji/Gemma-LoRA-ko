...
FINETUNE_MODEL = "./exper/FullFTModel/FFTModel-SummaryArticle." + dataset_size
...
for i in range(test_num):
    ...
    output_file = "./exper/InferenceResultFFT/SummaryArticle_" + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReportFFT/SummaryArticle_Inference_" + dataset_size + ".out"

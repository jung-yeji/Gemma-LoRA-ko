...
for i in range(test_num):
    ...
    if int(is_gemma_train) == 1:
        ...
        Gemma_file_name = "./exper/gemma_out/Gemma_Summary_output_" + str(i) + ".txt"
        Gemma_file = open(Gemma_file_name, "w")
        Gemma_file.write(Gemma_out)
        Gemma_file.close()
        Gemma_time_name = "./exper/gemma_out/Gemma_Summary_time_" + str(i) + ".txt"
    ...
    output_file = "./exper/InferenceResult/Summary.Rank" + str(rank) + "." + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReport/Summary_Inference.Rank" + str(rank) + "." + dataset_size + ".out"

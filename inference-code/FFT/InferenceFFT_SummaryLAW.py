...
test_dataset = "dataset-SummaryLAW-400"
...
for i in range(test_num):
    ...
    if int(is_gemma_train) == 1:
        ...
        Gemma_file_name = "./exper/gemma_out/Gemma_SummaryLAW_output_" + str(i) + ".txt"
        Gemma_file = open(Gemma_file_name, "w")
        Gemma_file.write(Gemma_out)
        Gemma_file.close()
        Gemma_time_name = "./exper/gemma_out/Gemma_SummaryLAW_time_" + str(i) + ".txt"
    ...
    output_file = "./exper/InferenceResultFFT/SummaryLAW_" + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReportFFT/SummaryLAW_Inference_" + dataset_size + ".out"

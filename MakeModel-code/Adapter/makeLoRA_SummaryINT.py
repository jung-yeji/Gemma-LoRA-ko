...
답변: {}<end_of_turn>
<start_of_turn>model
{}<end_of_turn><eos>""".format(example['question'][i], example['answer'][i], example['summary'][i]))
    return prompt_list
...
trainer = SFTTrainer(
    ...
    args=TrainingArguments(
        ...
        logging_dir="./exper/TrainingOutput_log/SummaryINT_Log",  # 로그 디렉토리 지정
    ),
...
ADAPTER_MODEL = "./exper/Adapter/LoRA_adapter-SummaryINT.Rank" + str(rank) + "." + dataset_size

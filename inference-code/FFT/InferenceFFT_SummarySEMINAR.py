...
FINETUNE_MODEL = "./exper/FullFTModel/FFTModel-SummarySEMINAR." + dataset_size
...
for i in range(test_num):
    ...
    output_file = "./exper/InferenceResultFFT/SummarySEMINAR_" + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReportFFT/SummarySEMINAR_Inference_" + dataset_size + ".out"

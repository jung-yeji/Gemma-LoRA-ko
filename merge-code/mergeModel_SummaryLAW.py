...
model.save_pretrained("./exper/MergeModel/summaryLAW-gemma-2b-it-sum-ko.Rank" + str(rank) + "." + dataset_size)

sec = (end - start)
result = datetime.timedelta(seconds=sec)
output_file = "./exper/MergeReport/mergeTime_SummaryLAW.Rank" + str(rank) + "." + dataset_size + ".out"

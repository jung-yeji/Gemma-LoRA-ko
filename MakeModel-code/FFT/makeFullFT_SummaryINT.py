...
답변: {answer}<end_of_turn>
<start_of_turn>model
{summary}<end_of_turn><eos>""" for question, answer, summary in zip(examples['question'], examples['answer'], examples['summary'])]}
...
dataset_path = 'dataset-SummaryINT-' + dataset_size
...
training_args = TrainingArguments(
    ...
    logging_dir="./exper/TrainingOutput_log/SummaryINT_FFT_Log",  # 로그 디렉토리 지정
)
...
save_directory = "./exper/FullFTModel/FFTModel-SummaryINT." + dataset_size

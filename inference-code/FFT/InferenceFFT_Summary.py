...
FINETUNE_MODEL = "./exper/FullFTModel/FFTModel-Summary." + dataset_size
...
for i in range(test_num):
    ...
    output_file = "./exper/InferenceResultFFT/Summary_" + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReportFFT/Summary_Inference_" + dataset_size + ".out"

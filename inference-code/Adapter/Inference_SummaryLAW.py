...
FINETUNE_MODEL = "./exper/MergeModel/summaryLAW-gemma-2b-it-sum-ko.Rank" + str(rank) + "." + dataset_size
...
for i in range(test_num):
    ...
    output_file = "./exper/InferenceResult/SummaryLAW.Rank" + str(rank) + "." + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReport/SummaryLAW_Inference.Rank" + str(rank) + "." + dataset_size + ".out"

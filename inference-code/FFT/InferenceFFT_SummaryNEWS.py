...
FINETUNE_MODEL = "./exper/FullFTModel/FFTModel-SummaryNEWS." + dataset_size
...
for i in range(test_num):
    ...
    output_file = "./exper/InferenceResultFFT/SummaryNEWS_" + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReportFFT/SummaryNEWS_Inference_" + dataset_size + ".out"

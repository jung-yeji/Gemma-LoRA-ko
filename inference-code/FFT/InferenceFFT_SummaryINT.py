...
is_gemma_train = sys.argv[3]

BASE_MODEL = "google/gemma-2b-it"
FINETUNE_MODEL = "./exper/FullFTModel/FFTModel-SummaryINT." + dataset_size
...
for i in range(test_num):
    ...
    output_file = "./exper/InferenceResultFFT/SummaryINT_" + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReportFFT/SummaryINT_Inference_" + dataset_size + ".out"

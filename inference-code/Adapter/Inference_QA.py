...
FINETUNE_MODEL = "./exper/MergeModel/QA-gemma-2b-it-sum-ko.Rank" + str(rank) + "." + dataset_size
...
for i in range(test_num):
    ...
    output_file = "./exper/InferenceResult/QA.Rank" + str(rank) + "." + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReport/QA_Inference.Rank" + str(rank) + "." + dataset_size + ".out"

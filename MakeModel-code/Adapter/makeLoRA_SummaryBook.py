...
{}<end_of_turn>
<start_of_turn>model
{}<end_of_turn><eos>""".format(example['passage'][i], example['summary'][i]))
    return prompt_list
...
dataset_path = 'dataset-SummaryBook-' + dataset_size
...
trainer = SFTTrainer(
    ...
    args=TrainingArguments(
        ...
        logging_dir="./exper/TrainingOutput_log/SummaryBook_Log",  # 로그 디렉토리 지정
    ),

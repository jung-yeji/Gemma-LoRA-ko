...
tans_type = sys.argv[5]

is_gemma_train = sys.argv[6]

BASE_MODEL = "google/gemma-2b-it"
# FINETUNE_MODEL = "./exper/MergeModel/Translate-gemma-2b-it-sum-ko.Rank" + str(rank) + "." + dataset_size
FINETUNE_MODEL = "./exper/MergeModel/Translate" + dataset_type + "-" + tans_type + "-gemma-2b-it-sum-ko.Rank" + str(rank) + "." + dataset_size
...
for i in range(test_num):
    ...
    output_file = "./exper/InferenceResult/Translate" + dataset_type + "-" + tans_type + ".Rank" + str(rank) + "." + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReport/Translate" + dataset_type + "-" + tans_type + "_Inference.Rank" + str(rank) + "." + dataset_size + ".out"

...
FINETUNE_MODEL = "./exper/MergeModel/summaryREPORT-gemma-2b-it-sum-ko.Rank" + str(rank) + "." + dataset_size
...
test_dataset = "datasetREPORT-400"
...
for i in range(test_num):
    ...
    if int(is_gemma_train) == 1:
        ...
        Gemma_file_name = "./exper/gemma_out/Gemma_SummaryREPORT_output_" + str(i) + ".txt"
        Gemma_file = open(Gemma_file_name, "w")
        Gemma_file.write(Gemma_out)
        Gemma_file.close()
        Gemma_time_name = "./exper/gemma_out/Gemma_SummaryREPORT_time_" + str(i) + ".txt"
    ...
    reference = doc['summary3'][i]
    
    output_file = "./exper/InferenceResult/SummaryREPORT.Rank" + str(rank) + "." + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReport/SummaryREPORT_Inference.Rank" + str(rank) + "." + dataset_size + ".out"
f2 = open(output_report, "w")
f2.write("Dataset: Summary REPORT\n")

...
FINETUNE_MODEL = "./exper/FullFTModel/FFTModel-SummaryConver." + dataset_size
...
for i in range(test_num):
    ...
    output_file = "./exper/InferenceResultFFT/SummaryConv_" + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReportFFT/SummaryConv_Inference_" + dataset_size + ".out"

...
{text}<end_of_turn>
<start_of_turn>model
{summary}<end_of_turn><eos>""" for text, summary in zip(examples['text'], examples['summary'])]}
...
dataset_path = 'dataset-SummaryNEWS-' + dataset_size
...
PARAMS = {
    ...
    'learning_rate':1e-7 # 학습률 증가
    # 'learning_rate':8e-7 # 학습률 증가
}
...
training_args = TrainingArguments(
    ...
    logging_dir="./exper/TrainingOutput_log/SummaryNEWS_FFT_Log",  # 로그 디렉토리 지정
)
...
save_directory = "./exper/FullFTModel/FFTModel-SummaryNEWS." + dataset_size

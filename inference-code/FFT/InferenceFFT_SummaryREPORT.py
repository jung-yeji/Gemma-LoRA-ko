...
FINETUNE_MODEL = "./exper/FullFTModel/FFTModel-SummaryLAW." + dataset_size
...
for i in range(test_num):
    ...
    output_file = "./exper/InferenceResultFFT/SummaryREPORT_" + dataset_size + "_" + str(i) + ".out"
...
output_report = "./exper/InferenceReportFFT/SummaryREPORT_Inference_" + dataset_size + ".out"

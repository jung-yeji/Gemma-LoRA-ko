...
dataset_path = 'dataset-SummaryArticle-' + dataset_size
...
training_args = TrainingArguments(
    ...
    logging_dir="./exper/TrainingOutput_log/SummaryArticle_FFT_Log",  # 로그 디렉토리 지정
)
...
save_directory = "./exper/FullFTModel/FFTModel-SummaryArticle." + dataset_size
